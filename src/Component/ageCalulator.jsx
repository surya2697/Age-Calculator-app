...
const AgeCalulator = () => {
 ...
 const [error,setError]=useState("")
  ...
  const hanldeSubmit=(e)=>{
    ...
    } else if (new Date(formData.year, formData.month - 1, formData.day) > new Date()) {
      setError("The date is in the future");
    } else if (isNaN(new Date(formData.year, formData.month - 1, formData.day))) {
  ...
  return (
    <>
      ...
      >
        ...
        <Text fontSize={{base:"50px",md:"",lg:"80px"}} marginTop={{base:"15px",md:"",lg:"10px"}} fontWeight="800">
          <span style={{color:"hsl(259, 100%, 65%)"}}>{ageYear}</span> years
        </Text>
        <Text fontSize={{base:"50px",md:"",lg:"80px"}}  fontWeight="800">
        <span style={{color:"hsl(259, 100%, 65%)"}}> {ageMonth}</span> months
        </Text>
        <Text fontSize={{base:"50px",md:"",lg:"80px"}} fontWeight="800">
